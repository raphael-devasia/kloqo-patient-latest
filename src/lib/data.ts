...
export const doctors: Doctor[] = [
  ...
  { id: 'doc2', name: 'Dr. Katherine Rose', specialty: 'Dermatology', avatar: findImage('doctor-2'), clinic: 'City Clinic', rating: 4.8, reviews: 92, currentToken: 32, location: { latitude: 40.7580, longitude: -73.9855 }, isFavourite: false, bio: 'Dr. Katherine Rose is a board-certified dermatologist specializing in cosmetic and medical dermatology. She is passionate about helping her patients achieve healthy, beautiful skin.' },
  { id: 'doc3', name: 'Dr. Varun Vikas', specialty: 'Pediatrics', avatar: findImage('doctor-3'), clinic: 'Wellness Clinic', rating: 5.0, reviews: 215, currentToken: 41, location: { latitude: 40.7128, longitude: -74.0060 }, isFavourite: false, bio: 'Dr. Varun Vikas is a caring and experienced pediatrician who is committed to the health and well-being of children. He takes a family-centered approach to care.' },
  { id: 'doc4', name: 'Dr. Dona Wilson', specialty: 'Neurology', avatar: findImage('doctor-4'), clinic: 'Healthway Medical', rating: 4.7, reviews: 89, currentToken: 18, location: { latitude: 40.730610, longitude: -73.935242 }, isFavourite: true, bio: 'Dr. Dona Wilson is a neurologist who specializes in the diagnosis and treatment of disorders of the nervous system. She has a special interest in migraine and epilepsy.' },
