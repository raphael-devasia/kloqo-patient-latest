        ...
        <div className="pb-6">
          ...
          <section className="space-y-4 pt-6">
            ...
            <div className="grid grid-cols-2 gap-4 w-1/2 pr-2">
                <Card className="flex items-center justify-center gap-1 py-1 px-2 bg-primary/10 border-primary/20">
                  <span className="font-semibold text-primary text-xs whitespace-nowrap">Near you</span>
                </Card>
                <Card className="flex items-center justify-center gap-1 py-1 px-2">
